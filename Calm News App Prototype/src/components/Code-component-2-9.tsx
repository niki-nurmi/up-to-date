    ...
    <div className="min-h-screen bg-background flex flex-col justify-center px-6 py-12">
      <div className="mx-auto w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Stay informed, stay calm</p>
        </div>
        ...
        <p className="text-xs text-muted-foreground text-center mt-8 leading-relaxed">
          By continuing, you agree to receive curated, neutral news summaries designed to inform without overwhelming.
        </p>
      </div>
    </div>
  );
